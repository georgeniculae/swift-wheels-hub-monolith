...
class ExceptionHandlingTest {
    ...
    void handleSwiftWheelsHubExceptionTest() {
        SwiftWheelsHubException notFoundException =
                new SwiftWheelsHubException(HttpStatus.BAD_REQUEST, "Resource not found");

        MockHttpServletRequest servletRequest = new MockHttpServletRequest();
        WebRequest webRequest = new ServletWebRequest(servletRequest);

        ResponseEntity<Map<String, Object>> responseEntity =
                exceptionHandling.handleSwiftWheelsHubException(notFoundException, webRequest);
