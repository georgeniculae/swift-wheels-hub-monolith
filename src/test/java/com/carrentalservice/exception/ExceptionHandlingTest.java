...
class ExceptionHandlingTest {
    ...
    @Test
    void handleCarRentalServiceExceptionTest() {
        CarRentalServiceException notFoundException =
                new CarRentalServiceException(HttpStatus.BAD_REQUEST, "Resource not found");

        MockHttpServletRequest servletRequest = new MockHttpServletRequest();
        WebRequest webRequest = new ServletWebRequest(servletRequest);

        ResponseEntity<Map<String, Object>> responseEntity =
                exceptionHandling.handleCarRentalServiceException(notFoundException, webRequest);
