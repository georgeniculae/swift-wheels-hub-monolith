...
public class SecurityConfig {
    ...
    @Bean
    public AuthenticationManager authenticatorManager(HttpSecurity http, PasswordEncoder passwordEncoder, UserDetailsService userDetailService) throws Exception {
